...
async def help_message(message: Message):
    text = (
        ...
        "💡 Могу помочь тебе с регистрацией в закрытой группе и предоставить информацию о торговле.\n\n"
        "❓ Если у тебя есть вопросы, ты можешь задать их мне! Я передам их создателю курса по торговле.\n\n"
        "🔗 Для регистрации в закрытой группе, переходи по [ссылке](https://example.com/register).\n\n"
